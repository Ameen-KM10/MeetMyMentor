...
const FeaturesSection = () => {
  ...
  return (
    ...
    >
      ...
      <h2 className="hidden lg:inline text-center font-bold font-sans text-[#FC8019] text-[67px] mb-10">
      ...
      <div className="flex flex-col justify-center items-center">
        <motion.div
          ...
          initial="hidden"
          animate={inView ? "show" : "hidden"}
          className="grid grid-cols-1 mb-10 lg:grid-cols-3 gap-8 w-full max-w-7xl"
        >
          {features.map((feature, idx) => (
            <motion.div
              key={feature.title}
              variants={cardVariants}
              className="bg-white rounded-md p-8 flex flex-col lg:gap-3 justify-center items-start min-h-[220px] lg:min-h-[320px] lg:hover:scale-105 lg:hover:shadow-md"
              style={{
                transitionProperty: "box-shadow, transform",
              }}
            >
              <img
                className="mb-4 ml-[-10px] h-[60px] lg:h-[80px]"
                src={feature.icon}
              />
